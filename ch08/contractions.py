...
↓ added by derodero24 ↓
Forked from https://gist.github.com/nealrs/96342d8231b75cf4bb82
Fix some problems
"""
import re
...
keys = sorted(cList.keys(), reverse=True)
c_re = re.compile('(%s)' % '|'.join(keys))
...
if __name__ == '__main__':
    ...
    print(expandContractions("He'd've"))
    print(expandContractions("I'm a person"))
